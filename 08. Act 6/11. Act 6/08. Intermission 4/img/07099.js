...
//	Create needed images! - R and L facing types (BEER - right, BEEL - left)
    sbeer.push("7099_1.htm");		//	firefly facing right sprite sheet load  - img source must be found here
    sbeel.push("7099_2.htm");	//	firefly facing left sprite sheet load	- img source must be found here
