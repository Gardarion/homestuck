...
if(Sburb.chooser.choices.length>0){Sburb.chooser.choices.push(new Sburb.Action("cancel","cancel","\u041e\u0442\u043c\u0435\u043d\u0430."));beginChoosing();}}}}
...
commands.saveOrLoad=function(info){var params=parseParams(info);var local=params.length>0&&params[0]=="true";var actions=[];if(Sburb.isStateInStorage(false,local)){actions.push(new Sburb.Action("load","false, "+local,"\u0417\u0430\u0433\u0440\u0443\u0437\u0438\u0442\u044c "+Sburb.getStateDescription(false)));}
if(Sburb.isStateInStorage(true,local)){actions.push(new Sburb.Action("load","true, "+local,"\u0417\u0430\u0433\u0440\u0443\u0437\u0438\u0442\u044c "+Sburb.getStateDescription(true)));}
if(Sburb.tests.storage){actions.push(new Sburb.Action("save","false,"+local,"\u0421\u043e\u0445\u0440\u0430\u043d\u0438\u0442\u044c"));}
actions.push(new Sburb.Action("cancel",null,"\u041e\u0442\u043c\u0435\u043d\u0430"));Sburb.chooser.choices=actions;Sburb.chooser.beginChoosing(Sburb.Stage.x+20,Sburb.Stage.y+50);}
